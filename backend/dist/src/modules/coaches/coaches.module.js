...
const tournament_coaches_controller_1 = require("./tournament-coaches.controller");
...
exports.CoachesModule = CoachesModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [coaches_controller_1.CoachesController, tournament_coaches_controller_1.TournamentCoachesController],
        providers: [coaches_service_1.CoachesService, prisma_service_1.PrismaService],
