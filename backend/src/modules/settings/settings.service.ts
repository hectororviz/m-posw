...
export class SettingsService {
  ...
  async get() {
    ...
    return {
      ...
      enableWhatsappModule: settings.enableWhatsappModule,
      openwaApiUrl: settings.openwaApiUrl,
      openwaApiKey: settings.openwaApiKey,
      openwaSessionName: settings.openwaSessionName,
      openwaMessageTemplate: settings.openwaMessageTemplate,
      openwaMinDelay: settings.openwaMinDelay,
      openwaMaxDelay: settings.openwaMaxDelay,
      enableNotificationsModule: settings.enableNotificationsModule,
      httpsmsApiKey: settings.httpsmsApiKey,
      httpsmsBaseUrl: settings.httpsmsBaseUrl,
  ...
  async update(dto: UpdateSettingDto) {
    const result = await this.prisma.setting.upsert({
      ...
      create: {
        ...
        enableWhatsappModule: dto.enableWhatsappModule ?? false,
      ...
      update: {
        ...
        ...(dto.enableWhatsappModule !== undefined ? { enableWhatsappModule: dto.enableWhatsappModule } : {}),
        ...(dto.openwaApiUrl !== undefined ? { openwaApiUrl: dto.openwaApiUrl } : {}),
        ...(dto.openwaApiKey !== undefined ? { openwaApiKey: dto.openwaApiKey } : {}),
        ...(dto.openwaSessionName !== undefined ? { openwaSessionName: dto.openwaSessionName } : {}),
        ...(dto.openwaMessageTemplate !== undefined ? { openwaMessageTemplate: dto.openwaMessageTemplate } : {}),
        ...(dto.openwaMinDelay !== undefined ? { openwaMinDelay: dto.openwaMinDelay } : {}),
        ...(dto.openwaMaxDelay !== undefined ? { openwaMaxDelay: dto.openwaMaxDelay } : {}),
        ...(dto.enableNotificationsModule !== undefined ? { enableNotificationsModule: dto.enableNotificationsModule } : {}),
        ...(dto.httpsmsApiKey !== undefined ? { httpsmsApiKey: dto.httpsmsApiKey } : {}),
        ...(dto.httpsmsBaseUrl !== undefined ? { httpsmsBaseUrl: dto.httpsmsBaseUrl } : {}),
        ...(dto.httpsmsFromNumber !== undefined ? { httpsmsFromNumber: dto.httpsmsFromNumber } : {}),
        ...(dto.httpsmsSigningKey !== undefined ? { httpsmsSigningKey: dto.httpsmsSigningKey } : {}),
        ...(dto.debtReminderTemplate !== undefined ? { debtReminderTemplate: dto.debtReminderTemplate } : {}),
