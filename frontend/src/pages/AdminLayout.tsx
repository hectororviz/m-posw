...
import { BarChart2, Boxes, Building2, ChevronDown, ChevronLeft, ChevronRight, House, Landmark, MonitorCog, Megaphone, Package, PenTool, Receipt, Settings, ShoppingCart, Smartphone, Store, Tag, Trophy, UserCog, UserMinus, Users, UsersRound, Wifi } from 'lucide-react';
...
const navCategories: NavCategoryDef[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { to: '/admin/whatsapp',  icon: <Smartphone size={iconSize} />, label: 'SMS',            moduleKey: 'enableNotificationsModule', permissionModule: 'NOTIFICACIONES' },
